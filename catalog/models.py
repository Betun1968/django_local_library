...
# Importa los modelos por defecto de Django
...
class Book(models.Model):
    ...
    # La clase Genre ya ha sido definida, entonces podemos especificar el objeto arriba. Se crea utomaticamente 
    # una tabla many to many

    languagebook = models.ForeignKey('languagebook', on_delete=models.SET_NULL, null=True)
...
class LanguageBook(models.Model):
    """
    Instancia para añadir el idioma al libro
    """

    languagebook = models.CharField(max_length=10, verbose_name="Idioma", help_text="Idioma del libro")

    def __str__(self):
        """
        String para representar el Objeto Modelo
        """
        return self.languagebook